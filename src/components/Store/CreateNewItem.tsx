        ...
        <div className="flex glass w-full h-full z-30 fixed left-0 top-0 items-center">
            <div className="bg-black-background w-2/5 h-content mx-auto p-6 flex flex-col gap-3">
                <div className="flex justify-between">
                    <h1 className="text-white font-SF-Pro font-bold text-5xl">Create new item</h1>
                ...
                <form onSubmit={upload} className="flex flex-col gap-2">
                    ...
                    <div className="flex w-full items-center justify-around accent-purple-interact">
                        <div className="flex gap-6">
                            ...
                            <input name="item-type" value="hat" onChange={(e) => setType(e.target.value)} className="w-5" type="radio" />
                        </div>
                        <div className="flex gap-6">
                            <input name="item-type" value="clothing" onChange={(e) => setType(e.target.value)} className="w-5" type="radio" />
                    ...
                    <div className="flex justify-between">
                        ...
                        <button disabled={message === "Successfully uploaded!"} onClick={upload} className="p-2 hover:bg-purple-interact transition-all  w-1/3 text-2xl font-bold font-SF-Pro text-white bg-black-container border-2 border-black-background focus:outline-none disabled:hover:bg-black-container disabled:text-zinc-700 disabled:hover:cursor-not-allowed">Create</button>
                    </div>
                </form>
            </div>
        </div>
